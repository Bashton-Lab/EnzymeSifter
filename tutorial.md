...
The input was a single multi-FASTA of **2,330,712 protein sequences** available at [Study MGYS00006774](https://www.ebi.ac.uk/metagenomics/studies/MGYS00006774/overview). After downloading and extracting the fasta file, sequence headers were cut at the first (-NODE-) to avoid very long headers, the gene number was kept so no duplicates appear in the initial dataset. The command used: 
